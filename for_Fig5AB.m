...
%% Data loading
filePath = 'data/';
load([filePath,'data_Fig5AB_hip_and_ankle_xy_coordination.mat']);
load([filePath,'data_Fig5AB_mean_firing_rate.mat']);
...
save_name = fullfile(figureFolder,'Figure5AB.emf');
