...
# Contents
・/ : Analysis scripts used for the figures.<br>
...
Launch MATLAB and change the working directory to the repository folder.<br>
Run the analysis scripts located in the top-level directory.
