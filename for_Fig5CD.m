...
%% Data loading
filePath = 'data/';
load([filePath,'data_Fig5CD_hip_and_ankle_xy_coordination_catB.mat']);
load([filePath,'data_Fig5CD_mean_firing_rate_catB.mat']);
...
save_name = fullfile(figureFolder,'Figure5CD.emf');
